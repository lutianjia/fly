<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/var/www/html/fly/public/../application/admin/view/member/member-del.html";i:1590028976;s:58:"/var/www/html/fly/application/admin/view/public/_meta.html";i:1589178985;s:60:"/var/www/html/fly/application/admin/view/public/_footer.html";i:1589360206;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form action="<?php echo url('Member/memberDel'); ?>" method="get">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tr class="text-c" id="<?php echo $vo['id']; ?>">
			...
			<?php endif; ?>
			<td class="td-manage">
				<a style="text-decoration:none" href="javascript:;" onClick="member_huanyuan(this,'<?php echo $vo['id']; ?>')" title="还原"><i class="Hui-iconfont">&#xe66b;</i></a>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: "<?php echo url('SetStatus/thoroughDel'); ?>",
			dataType: 'json',
			data:{
				id:id,
				table:'User'
...
function datadel() {
	layer.confirm('确定要执行批量删除吗？',function(index) {
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo url('SetStatus/thoroughDelete'); ?>",
			dataType: 'json',
			data:{
				id:id,
				table:'User'
